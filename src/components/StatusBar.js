        ...
        <div>
            <div className="status">
                ...
                <div className="activity">
                    <div className="btn">
                        <img src={require("../images/photo.png")} className="image" alt="video" />
                        <span className="act"><strong>Photo/Video</strong></span> 
                    </div>
                    <div className="btn">
                        <img src={require("../images/tag.png")} className="image" alt="tag" />
                        <span className="act"><strong>Tag Friends</strong></span>
                    </div>
                    <div className="btn">
                        <img src={require("../images/feel.png")} className="image" alt="feel" />
